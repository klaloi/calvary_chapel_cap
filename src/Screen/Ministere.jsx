...
import CalvaryPAPImage from '../assets/Calvary_chapel_pap.png';
...
const CalvaryPAPMinistere = () => {
  return (
    <section className="parole-section">
      <div className="parole-image-container">
        <img
          src={CalvaryPAPImage}
          alt="Calvary Chapel Port-au-Prince"
          className="parole-image"
        />
        <div className="parole-overlay"></div>

        <div className="parole-content-overlay">
          <h2 className="parole-overlay-title">Calvary Chapel Port-au-Prince</h2>

          <p className="parole-overlay-description">
            Église-mère de Calvary Chapel Cap-Haïtien, fondée ar le Pasteur Seige POTEAU et dirigée par le Pasteur Fenel JOCELIN.
            Même vision, même enseignement : la Parole de Dieu verset par verset, pour faire des disciples
            au cœur de la capitale haïtienne.
          </p>
